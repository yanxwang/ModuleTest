...
df = pd.read_csv("cpu0_all_runs.log")
...
plt.title("Baseline: CPU 0 Utilization Over Time (All Runs)")
plt.ylim(0, 105)
plt.legend()
plt.grid(True, linestyle="--", alpha=0.6)
plt.tight_layout()
plt.savefig("cpu0_utilization_all_runs.png", dpi=300)
print("Line chart saved as cpu0_utilization_all_runs.png")
