...
# Load CSV file
data = pd.read_csv("uintrpoller_test_results.csv")
...
plt.title("UINTR Poller: Synchronizer Throughput vs Number of Clients")
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()

# Save figure as PNG
plt.savefig("uintrpoller_throughput_vs_clients_bar.png", dpi=300)
print("Bar chart saved as uintrpoller_throughput_vs_clients_bar.png")
