...
# Load latency CSV
df = pd.read_csv("uintrpoller_latency_all_runs.csv")
...
plt.title("UINTR Poller: Per-Request Latency vs Number of Clients")
plt.legend()
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()

# Save figure
plt.savefig("uintrpoller_latency_vs_clients.png", dpi=300)
print("Latency plot saved as uintrpoller_latency_vs_clients.png")
